<template>
    <div class="member">
        <el-button type="primary" size="small" @click="handleAdd">新增作者</el-button>
        <div class="table-area">
            <el-table :data="data" size="small" class="table" border stripe show-overflow-tooltip>
                <el-table-column prop="id" label="ID" width="50" />
                <el-table-column prop="name" label="姓名" width="100" />
                <el-table-column prop="intro" label="简介" width="800" />
        ...
        <el-dialog v-model="dialogVisible" :title="dialogTitle">
            <el-form :model="form" label-width="120px" label-position="top">
                ...
                <el-form-item label="简介">
                    <el-input type="textarea" v-model="form.intro" :autosize="{ minRows: 10, maxRows: 20 }"
                        placeholder="请输入作者简介" />
                </el-form-item>
...
import { list, add, edit, del } from '@/api/author'
